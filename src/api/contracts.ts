...
export interface ApiPost { postId: number; boardId: number; title: string; titleKr?: string; titleEn?: string; author: string; content: string; contentKr?: string; contentEn?: string; viewCount: number; likeCount: number; commentCount: number; createdAt: string | null; updatedAt: string | null; tags: ApiTag[]; media: ApiMedia[] }
export interface ApiComment { commentId: number; postId: number; parentId: number | null; author: string; content: string; contentKr?: string; contentEn?: string; createdAt: string | null; updatedAt: string | null; children?: ApiComment[] }
