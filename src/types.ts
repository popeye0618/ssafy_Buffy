...
export interface Post { id: string; boardId: string; title: string; body: string; tags: Tag[]; views: number; likes: number; comments: number; date: string; updatedAt?: string; author: string; liked?: boolean; images: number; media: Media[] }
export interface Comment { id: string; postId: string; parentId?: string; author: string; body: string; date: string; updatedAt?: string; likes: number; deleted?: boolean }
